...
{
    /// <summary>
    /// ScriptableObject holding AppMachina SDK build settings for iOS and Android.
    /// Create via Assets > Create > AppMachina > Settings, then place in a Resources folder.
    /// The post-build processors read these settings automatically.
    /// </summary>
    [CreateAssetMenu(fileName = "AppMachinaSettings", menuName = "AppMachina/Settings")]
    public class AppMachinaSettings : ScriptableObject
    {
        // ── iOS ─────────────────────────────────────────────────────────
        ...
        private static AppMachinaSettings _instance;

        /// <summary>
        /// Load the first AppMachinaSettings asset found in any Resources folder.
        /// Returns null if no asset has been created.
        /// </summary>
        public static AppMachinaSettings Instance
        {
            get
            {
                if (_instance == null)
                    _instance = Resources.Load<AppMachinaSettings>("AppMachinaSettings");
                return _instance;
            }
        }
        ...
        /// <summary>
        /// The 16 default SKAdNetwork identifiers shared across all AppMachina SDKs
