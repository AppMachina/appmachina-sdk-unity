...
namespace AppMachina.Unity.Internal
{
    ...
    internal static class WebGLDeviceInfoCollector
    {
        internal static Dictionary<string, object> Collect()
        {
            ...
            string locale = WebGLStringHelper.ReadAndFree(WebGLBindings.AppMachinaWebGL_GetLanguage())
                            ?? System.Globalization.CultureInfo.CurrentCulture.Name;
            string screenSize = WebGLStringHelper.ReadAndFree(WebGLBindings.AppMachinaWebGL_GetScreenSize())
                                ?? $"{Screen.width}x{Screen.height}";
            string timezone = WebGLStringHelper.ReadAndFree(WebGLBindings.AppMachinaWebGL_GetTimezone())
                              ?? System.TimeZoneInfo.Local.Id;
            string osVersionRaw = WebGLStringHelper.ReadAndFree(WebGLBindings.AppMachinaWebGL_GetPlatformOS())
