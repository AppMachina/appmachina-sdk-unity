...
namespace AppMachina.Unity
{
    ...
    public static class AdServicesModule
    {
        ...
        private static extern bool appmachina_adservices_is_available();

        [DllImport("__Internal")]
        private static extern IntPtr appmachina_adservices_get_token();
#endif
        ...
        {
#if UNITY_IOS && !UNITY_EDITOR
            return appmachina_adservices_is_available();
#else
            return false;
#endif
        }
...
#if UNITY_IOS && !UNITY_EDITOR
            IntPtr ptr = appmachina_adservices_get_token();
            if (ptr == IntPtr.Zero)
            {
                _cachedToken = null;
                return null;
