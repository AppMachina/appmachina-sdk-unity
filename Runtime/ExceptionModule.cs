...
namespace AppMachina.Unity
{
    ...
    ///
    /// Opt-out via <see cref="AppMachinaConfig.AutoTrackExceptions"/> (default true,
    ...
    internal static class ExceptionModule
    {
        ...
        // frame by AppMachinaRunner. ConcurrentQueue keeps the producer side
        ...
        internal static void Install(bool captureLogErrors, bool enableDebug)
        {
            ...
            if (s_enableDebug)
                AppMachinaLogger.Log("ExceptionModule installed");
        }
        ...
        /// <see cref="AppMachinaRunner.Update"/> so that any
        /// <c>logMessageReceivedThreaded</c> calls from C# tasks / native
        /// callbacks reach <see cref="AppMachinaSDK.Track"/> on the main thread.
        /// </summary>
        ...
        /// <see cref="AppMachinaSDK.TrackException(Exception, bool)"/> callers.
        /// </summary>
        ...
        /// <see cref="AppMachinaRunner.Awake"/> because the static field
            ...
            string condition, string stackTrace, LogType type, bool isMainThread)
        {
            try
            {
                ...
                AppMachinaSDK.Track(ExceptionEventName, props);
            }
            catch (Exception e)
            {
                ...
                // and recurse.
                if (s_enableDebug)
                    AppMachinaLogger.Warn($"ExceptionModule failed to emit: {e.Message}");
            }
        }
