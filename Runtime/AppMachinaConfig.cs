...
{
    /// <summary>
    /// Environment for the AppMachina SDK. Controls which ingest endpoint is used
    /// and is sent as the X-Environment header.
    /// </summary>
    public enum AppMachinaEnvironment
    {
        Development,
        Staging,
        Production
    ...
    /// <summary>
    /// Configuration for initializing the AppMachina SDK.
    /// Only AppId is required; all other fields have sensible defaults.
    /// </summary>
    public class AppMachinaConfig
    {
        /// <summary>
        /// The application ID assigned in the AppMachina dashboard. Required.
        /// </summary>
        ...
        /// </summary>
        public AppMachinaEnvironment Environment { get; set; } = AppMachinaEnvironment.Production;

        /// <summary>
        /// Override the base URL for the ingest endpoint. Null uses the default (in.appmachina.com).
        ...
        /// the ingest server. Use <see cref="AppMachinaSDK.GetDebugToken"/>
        ...
        /// during <see cref="AppMachinaSDK.Initialize"/> — before the first
        ...
        /// </summary>
        public AppMachinaFeatureFlagBootstrap FeatureFlagBootstrap { get; set; }
    }
}
