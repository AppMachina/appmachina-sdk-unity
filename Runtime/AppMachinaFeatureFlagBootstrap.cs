...
namespace AppMachina.Unity
{
    ...
    ///
    /// Set via <see cref="AppMachinaConfig.FeatureFlagBootstrap"/> at init,
    /// or post-init via <see cref="AppMachinaSDK.SetFeatureFlagBootstrap"/>.
    ...
    /// first paint.</para>
    /// </summary>
    public class AppMachinaFeatureFlagBootstrap
    {
        /// <summary>
        ...
        /// <see cref="AppMachinaSDK.GetFeatureFlagPayload"/>; payload reads
