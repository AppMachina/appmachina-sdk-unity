...
{
    /// <summary>
    /// Commerce tracking module for the AppMachina Unity SDK.
    ///
    ...
    /// <see cref="AppMachinaSDK.Track"/> with standardized event names and properties
    ...
    public static class Commerce
    {
            ...
            string store = null)
        {
            ...
            AppMachinaSDK.Track("purchase_success", props);
        }
            ...
            string errorMessage = null)
        {
            ...
            AppMachinaSDK.Track("purchase_failed", props);
        }
            ...
            string originalTransactionId = null)
        {
            ...
            AppMachinaSDK.Track("subscribe", props);
        }
            ...
            string category = null)
        {
            ...
            AppMachinaSDK.Track("add_to_cart", props);
        }
            ...
            string category = null)
        {
            ...
            AppMachinaSDK.Track("remove_from_cart", props);
        }
            ...
            int? itemCount = null)
        {
            ...
            AppMachinaSDK.Track("begin_checkout", props);
        }
            ...
            string category = null)
        {
            ...
            AppMachinaSDK.Track("view_item", props);
        }
            ...
            string reason = null)
        {
            ...
            AppMachinaSDK.Track("refund", props);
        }
    }
}
