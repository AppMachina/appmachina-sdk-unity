...
namespace AppMachina.Unity.Internal
{
    ...
    /// Every non-null IntPtr returned by a appmachina_* function MUST be freed exactly once.
    /// </summary>
    internal static class NativeStringHelper
    {
        ...
        internal static string ReadAndFree(IntPtr ptr)
        {
            ...
            {
                NativeBindings.appmachina_free_string(ptr);
            }
        }

        /// <summary>
        /// Process a result pointer from a appmachina_* call that uses the success/error convention.
