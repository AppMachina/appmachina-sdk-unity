...
namespace AppMachina.Unity.Internal
{
    ...
    /// has never run before (no <c>appmachina_install_id</c> in PlayerPrefs), this
    ...
    {
        private const string FirstLaunchKey = "appmachina_first_launch_tracked";
        ...
        private static extern long appmachina_get_first_install_time_ms();
#endif
        ...
        /// <summary>
        /// Snapshot whether <c>appmachina_install_id</c> already exists in PlayerPrefs.
        /// Must be called BEFORE <see cref="InstallIdProvider.GetOrCreate"/>.
        /// </summary>
        internal static void CapturePreInitState()
        {
            _hadInstallIdBeforeInit = PlayerPrefs.HasKey("appmachina_install_id");
        }

        /// <summary>
        /// Determine whether this is a genuine new install or an existing app
        /// that just added the AppMachina SDK.
        ///
        /// Logic:
        /// 1. If the flag says this is NOT the first launch, respect that.
        /// 2. If the SDK had prior state (appmachina_install_id already existed in
        ...
        internal static bool ShouldTreatAsNewInstall(bool isFirstLaunchByFlag, bool hadPriorState)
        {
            ...
            {
                AppMachinaLogger.Warn($"Failed to read firstInstallTime: {e.Message}");
        ...
        {
#if UNITY_IOS && !UNITY_EDITOR
            return appmachina_get_first_install_time_ms();
        ...
        private static long GetAndroidFirstInstallTime()
        {
            ...
            {
                AppMachinaLogger.Warn($"Android firstInstallTime failed: {e.Message}");
                return 0;
            }
        }
#endif
