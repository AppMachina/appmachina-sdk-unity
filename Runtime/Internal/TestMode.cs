...
namespace AppMachina.Unity.Internal
{
    ...
    ///
    /// When enabled via <see cref="AppMachinaTestMode.Enable"/>, the SDK uses this
    ...
    /// public void SetUp()
    /// {
    ///     AppMachinaTestMode.Enable();
    ///     AppMachinaSDK.Initialize(new AppMachinaConfig { AppId = "test-app" });
    /// }
    ///
    /// [TearDown]
    ...
    ///     AppMachinaTestMode.Disable();
    /// }
    /// </code>
    /// </summary>
    internal class MockPlatform : IAppMachinaPlatform
    {
        ...
        // implementation is forwarded as `IAppMachinaPlatform.Reset()` and the
        // test helper is renamed to `ClearTestState`.
        string IAppMachinaPlatform.Reset()
        {
            ResetCalls++;
            return null;
        }
        ...
        /// <see cref="IAppMachinaPlatform.Reset"/> SDK reset path so callers
    ...
    ///
    /// When test mode is enabled, <see cref="AppMachinaPlatformFactory.Create"/> returns
    ...
    /// </summary>
    public static class AppMachinaTestMode
    {
        ...
        /// <summary>
        /// Enable test mode. Subsequent calls to <see cref="AppMachinaPlatformFactory.Create"/>
        ...
        /// </summary>
        internal static IAppMachinaPlatform GetMockPlatform() => _mockPlatform;
    }
}
