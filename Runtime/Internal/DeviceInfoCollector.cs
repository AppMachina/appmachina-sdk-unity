...
namespace AppMachina.Unity.Internal
{
    ...
    internal static class DeviceInfoCollector
    {
        ...
        private static extern IntPtr appmachina_ios_get_os_version();

        [DllImport("__Internal")]
        private static extern IntPtr appmachina_ios_get_device_model();

        [DllImport("__Internal")]
        private static extern IntPtr appmachina_ios_get_app_version();

        [DllImport("__Internal")]
        private static extern IntPtr appmachina_ios_get_build_number();

        [DllImport("__Internal")]
        private static extern void appmachina_devinfo_free(IntPtr ptr);
        ...
        {
#if UNITY_IOS && !UNITY_EDITOR
            return ReadNativeString(appmachina_ios_get_os_version());
        ...
        {
#if UNITY_IOS && !UNITY_EDITOR
            return ReadNativeString(appmachina_ios_get_device_model());
#elif UNITY_ANDROID && !UNITY_EDITOR
        ...
        {
#if UNITY_IOS && !UNITY_EDITOR
            return ReadNativeString(appmachina_ios_get_app_version());
#elif UNITY_ANDROID && !UNITY_EDITOR
        ...
        {
#if UNITY_IOS && !UNITY_EDITOR
            return ReadNativeString(appmachina_ios_get_build_number());
#elif UNITY_ANDROID && !UNITY_EDITOR
