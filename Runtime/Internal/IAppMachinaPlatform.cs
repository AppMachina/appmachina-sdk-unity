...
{
    /// <summary>
    /// Platform abstraction for the AppMachina SDK. Separates native (iOS/Android/desktop)
    ...
    ///
    /// The <see cref="AppMachinaSDK"/> facade uses <see cref="AppMachinaPlatformFactory.Create"/>
    /// to select the correct implementation at runtime.
    /// </summary>
    internal interface IAppMachinaPlatform
    {
        // ── Lifecycle ──────────────────────────────────────────────────
